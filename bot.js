...
mongoose.connect('MONGO DB LİNK', {useNewUrlParser: true, useUnifiedTopology: true});
...
client.login(ayarlar.token).then(x => console.log(`Bot ${client.user.tag} olarak giriş yaptı!`)).catch(err => console.error(`Bot ${client.user.tag} giriş yapamadı | Hata: ${err}`));
